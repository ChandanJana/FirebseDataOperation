package com.example.janac.firebsedataoperation;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String ARTIST_NAME = "com.example.janac.firebaseoperation.artistname";
    public static final String ARTIST_ID = "com.example.janac.firebaseoperation.artistid";
    ...
    protected void onStart() {
        ...
        databaseArtists.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                CustomArtistAdapter artistAdapter = new CustomArtistAdapter(MainActivity.this, artists);
